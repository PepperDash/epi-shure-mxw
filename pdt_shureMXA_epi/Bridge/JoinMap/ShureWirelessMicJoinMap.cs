...
namespace ShureWireless.Bridge.JoinMap
{
    public class ShureWirlessMicJoinmap : JoinMapBaseAdvanced
    {
        public ShureWirlessMicJoinmap(uint joinStart)
            : base(joinStart, typeof(ShureWirlessMicJoinmap))
        {
        ...
        public JoinDataComplete ChargerIsOnline =
            new JoinDataComplete(new JoinData { JoinNumber = 42, JoinSpan = 4 },
            new JoinMetadata
            {
        ...
        [JoinName("ChargerIsPresent")]
        public JoinDataComplete Charger2IsPresent =
            new JoinDataComplete(new JoinData { JoinNumber = 46, JoinSpan = 1 },
            new JoinMetadata
            {
